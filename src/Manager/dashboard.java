...
public class dashboard extends JFrame {
    ...
    private JPanel buildDashboardPanel() {
        ...
        // Top: Revenue
        JPanel pnlRevenue = new JPanel();
        pnlRevenue.setBorder(new TitledBorder("Revenue"));
        pnlRevenue.add(new JLabel("<< Revenue Chart Here >>"));
        dash.add(pnlRevenue, BorderLayout.NORTH);
        ...
        pnlApp.setBorder(new TitledBorder("Appointment Count"));
        pnlApp.add(new JLabel("100 This Month", JLabel.CENTER), BorderLayout.CENTER);
        bottom.add(pnlApp);

        // Feedback
        JPanel pnlFeed = new JPanel(new BorderLayout());
        pnlFeed.setBorder(new TitledBorder("Feedback for Doctor/Staff"));
        pnlFeed.add(new JLabel("<< Feedback Table Here >>", JLabel.CENTER), BorderLayout.CENTER);
        bottom.add(pnlFeed);

        dash.add(bottom, BorderLayout.CENTER);
        return dash;
    }
}
